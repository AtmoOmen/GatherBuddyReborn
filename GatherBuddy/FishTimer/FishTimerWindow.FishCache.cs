                ...
                if (hookIcon?.TryGetWrap(out var wrap2, out _) ?? false)
                {
                    ...
                    if (ImGui.IsItemHovered())
                    {
                        ...
                        if (_fish.MutliHookUpper == _fish.MultiHookLower)
                        {
                            ...
                            ImUtf8.Text($"三重提钩: {2 * _fish.MultiHookLower - 1} 条鱼{(_fish.Points > 0 ? $" 价值 {_fish.Points * (2 * _fish.MultiHookLower - 1)} 点" : "")}"); 
                        ...
                        {
                            ImUtf8.Text($"双重提钩: {_fish.MultiHookLower}-{_fish.MutliHookUpper} 条鱼" +
                                $"{(_fish.Points > 0 ? $" 价值在 {_fish.Points * _fish.MultiHookLower} - {_fish.Points * _fish.MutliHookUpper} 点之间" : "")}");
                            ImUtf8.Text($"三重提钩: {2 * _fish.MultiHookLower - 1}-{2 * _fish.MutliHookUpper - 1} 条鱼" +
                                $"{(_fish.Points > 0 ? $" 价值在 {_fish.Points * (2 * _fish.MultiHookLower - 1)} - {_fish.Points * (2 * _fish.MutliHookUpper - 1)} 点之间" : "")}");
                            //TODO: See above
                        }
